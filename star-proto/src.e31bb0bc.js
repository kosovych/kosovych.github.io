...
function setDOMReacts() {
  Array.from(document.querySelectorAll('.star')).forEach(function (star) {
    var id = star.id;
    var DOMReact = star.getBoundingClientRect();
    state[id] = DOMReact;
  });
}
...
function goToStar(star) {
  ...
  state.focusedStarId = star.id;
  var originalDOMReact = state[star.id];
  var newX;
  ...
  var transformObject = {
    ...
    onComplete: function onComplete() {
      if (!state["gsap".concat(state.focusedStarId)]) {
        state["gsap".concat(star.id)] = _gsap.default.to("#".concat(state.focusedStarId, " .star-inner"), {
        ...
        state["gsap".concat(state.focusedStarId)] = state["gsap".concat(state.focusedStarId)].play();
      }
    }
  };
  ...
  _gsap.default.to('#constellation', transformObject);
}

function minimyzeConstellation() {
  var windowInnerHeight = window.innerHeight;
  var constellationHeight = constellation.offsetHeight;
  var difference = 1 / (constellationHeight / windowInnerHeight);
  state.currentScale = difference;
  state.isMenuStateBig = false;
  state.currentX = 0;
  state.currentY = 0;
  state["gsap".concat(state.focusedStarId)] = state["gsap".concat(state.focusedStarId)].pause();
  return _gsap.default.to('#constellation', {
    scale: state.currentScale,
    x: state.currentX,
    y: state.currentY,
    duration: 0.5
...
},{"gsap":"../node_modules/gsap/index.js"}],"../../../AppData/Roaming/nvm/v10.20.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../AppData/Roaming/nvm/v10.20.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
